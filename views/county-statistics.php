        ...
        <div class="charts">
            <div class="bar-chart">
                ...
                <div class="buttons-bar">
                    <button id="download-chart-bar" class="download-button"><i class="fa fa-download"></i>  Descarca grafic</button>
                    <button id="download-data-bar" class="download-button"><i class="fa fa-download"></i>  Descarca datele</button>
                </div>
            </div>
            <div class="doughnut-chart">
                ...
                <div class="buttons-doughnut">
                    <button id="download-chart-doughnut" class="download-button"><i class="fa fa-download"></i>  Descarca grafic</button>
                    <button id="download-data-doughnut" class="download-button"><i class="fa fa-download"></i>  Descarca datele</button>
                </div>
            ...
            <div class="line-chart">
                ...
                <div class="buttons-line">
                    <button id="download-chart-line" class="download-button"><i class="fa fa-download"></i>  Descarca grafic</button>
                    <button id="download-data-line" class="download-button"><i class="fa fa-download"></i>  Descarca datele</button>
                </div>
            </div>
        </div>
    </section>
